...
This is the first of several changes to where your data lives and how your app tracks the logged-in user. For the big picture of how those pieces evolve across the whole course, see the [Data and Identity guide](?page=data-and-identity-guide).
